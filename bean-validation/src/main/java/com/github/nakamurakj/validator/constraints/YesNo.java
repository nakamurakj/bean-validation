...
import com.github.nakamurakj.validator.constraintsvalidaor.YesNoValidator;
...
public @interface YesNo {
    ...
    String message() default "{com.github.nakamurakj.validator.constraints.YesNo.message}";
