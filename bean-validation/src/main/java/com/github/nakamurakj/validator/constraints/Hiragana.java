...
import com.github.nakamurakj.validator.constraintsvalidaor.HiraganaValidator;
...
public @interface Hiragana {
    ...
    String message() default "{com.github.nakamurakj.validator.constraints.Hiragana.message}";
