...
import com.github.nakamurakj.validator.constraints.Charset;

/**
 * CharsetのConstraintValidator
 */
public class CharsetValidator implements ConstraintValidator<Charset, String> {
     ...
     */
    @Override
    public void initialize(Charset constraint) {}
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        return isCharsetSupported(value);
    }
}