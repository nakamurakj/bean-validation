...
public class HalfKatakanaTest {

    public static final String KATAKANA = "ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄ"
            + "ﾅﾆﾇﾈﾉﾊﾌﾌﾍﾎﾔﾕﾖﾜｦﾝ"
            + "ｶﾞｷﾞｸﾞｹﾞｺﾞｻﾞｼﾞｽﾞｾﾞｿﾞﾀﾞﾁﾞﾂﾞﾃﾄﾞﾊﾞﾋﾞﾌﾞﾍﾞﾎﾞﾊﾟﾋﾟﾎﾟﾍﾟﾎﾟ";
    ...
    public void test() {
        ...
        assertEquals("The format of \"Half-Katakana\" is invalid.", validates.get(0).getMessage());
    }
