...
import com.github.nakamurakj.validator.constraintsvalidaor.NumberStringValidator;
...
public @interface NumberString {
    ...
    String message() default "{com.github.nakamurakj.validator.constraints.NumberString.message}";
