...
import com.github.nakamurakj.validator.constraintsvalidaor.BooleanStringValidator;
...
public @interface BooleanString {
    ...
    String message() default "{com.github.nakamurakj.validator.constraints.BooleanString.message}";
