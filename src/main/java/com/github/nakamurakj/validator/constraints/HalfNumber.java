...
import com.github.nakamurakj.validator.constraintsvalidaor.HalfNumberValidator;
...
public @interface HalfNumber {
    ...
    String message() default "{com.github.nakamurakj.validator.constraints.HalfNumber.message}";
